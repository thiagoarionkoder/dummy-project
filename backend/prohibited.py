...
def categorise_biometrics(face_photo=None, name: str = "") -> dict:
    raise NotImplementedError("categorise_biometrics is disabled: biometric categorisation guessing ethnicity, religion, or political leaning in employment is prohibited under EU AI Act Art. 5.")
